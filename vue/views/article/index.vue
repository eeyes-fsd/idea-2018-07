      ...
      <div>
        <div class="row">
          ...
          <div class="col-md-4  panel panel-default author-info">
            <router-link :to="`/user/${author.id}/article`"><img :src="author.avatar" alt="head" class="author-head img-circle"></router-link>
            <router-link :to="`/user/${author.id}/article`"><h4>{{ author.nickname }}</h4></router-link>
